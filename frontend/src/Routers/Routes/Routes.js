...
import ProductDetails from "../../Pages/HomePage/ProductCategories/ProductDetails/ProductDetails";
...
export const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      },
      {
        ...
        loader: ({ params }) =>
          fetch(
            `https://truckbazar-server-side.vercel.app/category/${params.id}`,
            {
              headers: {
      ...
      },
      {
        ...
        loader: ({ params }) =>
          fetch(
            `https://truckbazar-server-side.vercel.app/product/${params.id}`,
            {
              headers: {
                authorization: `bearer ${localStorage.getItem("user-token")}`,
              },
